...
<div style="width: 90%;margin-left: 5%;">
    ...
    <div style="width: 100%;height: 200px;border-radius: 5px;border:1px solid #f79807;background-color: #ffffff;margin-top: 15px;">
        ...
        <div style="width: 100%;height: 35px;border-bottom: 1px solid #f79807;">
            ...
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;border-left: 1px solid #f79807;border-right: 1px solid #f79807;">垃圾未分类</p>
        ...
        <div style="width: 100%;height: 35px;border-bottom: 1px solid #f79807;">
            ...
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;border-left: 1px solid #f79807;border-right: 1px solid #f79807;">动物圈养不规范</p>
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: right;">-2</p>
        </div>
        <div style="width: 100%;height: 35px;border-bottom: 1px solid #f79807;">
            <p style="width: 66.3%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;">合计</p>
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: right;border-left: 1px solid #f79807;">-7</p>
        </div>
    </div>
</div>
</body>
