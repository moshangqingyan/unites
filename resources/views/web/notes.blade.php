...
<div style="width: 90%;margin-left: 5%;">
    ...
    <div style="width: 100%;height: 340px;border-radius: 5px;border:1px solid #f79807;background-color: #ffffff;margin-top: 15px;">
        ...
        <div style="width: 100%;height: 35px;border-bottom: 1px solid #f79807;">
            ...
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;border-left: 1px solid #f79807;border-right: 1px solid #f79807;">2kg洗衣粉一包</p>
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: right;">6</p>
        </div>
        ...
        <div style="width: 100%;height: 35px;border-bottom: 1px solid #f79807;">
            ...
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;border-left: 1px solid #f79807;border-right: 1px solid #f79807;">香皂一个</p>
        ...
        <div style="width: 100%;height: 35px;border-bottom: 1px solid #f79807;">
            ...
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;border-left: 1px solid #f79807;border-right: 1px solid #f79807;">蚊香一盒</p>
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: right;">6</p>
        </div>
        <div style="width: 100%;height: 35px;border-bottom: 1px solid #f79807;">
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;">2020-5-22</p>
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;border-left: 1px solid #f79807;border-right: 1px solid #f79807;">抽纸一提</p>
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: right;">10</p>
        </div>
        <div style="width: 100%;height: 35px;border-bottom: 1px solid #f79807;">
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;">2020-5-20</p>
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;border-left: 1px solid #f79807;border-right: 1px solid #f79807;">洗洁精一瓶</p>
        ...
        <div style="width: 100%;height: 35px;border-bottom: 1px solid #f79807;">
            ...
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;border-left: 1px solid #f79807;border-right: 1px solid #f79807;">牙膏一盒</p>
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: right;">5</p>
        </div>
        <div style="width: 100%;height: 35px;border-bottom: 1px solid #f79807;">
            <p style="width: 66.3%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: left;">合计</p>
            <p style="width: 33.1%;height: 100%;line-height: 35px;color: #666;text-align: center;font-size: 1em;float: right;border-left: 1px solid #f79807;">45</p>
        </div>
    </div>
</div>
</body>
